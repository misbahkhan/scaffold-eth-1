...
import { Header, Account, Faucet, Ramp, Contract, GasGauge, Address, AddressInput, ThemeSwitch, CircleFinModal } from "./components";
    ...
    if(loadedAssets[a].forSale){
      cardActions.push(
        <div>
          ...
          <CircleFinModal visible="false"></CircleFinModal>
        </div>
      )
    }else{
      cardActions.push(
